...
map.getView().fit([144835.778952, 120182.195166, 175744.112371, 137375.648021], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Census Data of Neluwa Pradeshiya Sabha (2012)</h2>';
        return titleElement;
    })(),
